...
from FrameworkAIAgents import Scenario
...
class TestSetupEnv:
    def test_setup_env_sets_key_when_present(self, monkeypatch):
        ...
        with patch.object(Scenario, "load_dotenv") as mock_dotenv:
...
class TestConstants:
    def test_db_system_message_contains_database_instructions(self):
        # DB agent message must reference the correct database name
    ...
    def test_api_system_message_contains_api_instructions(self):
        # API agent message must reference the registration endpoint
    ...
    def test_excel_system_message_contains_excel_instructions(self):
        # Excel agent message must reference the output file
    ...
    def test_task_description_references_all_steps(self):
        # Task description must mention all three agents' steps
...
class TestModuleStructure:
    ...
    def test_module_exposes_all_system_message_constants(self):
